...
| Ф5 — приёмка паритета + e2e | 🔄 **следующая** |
| Ф6 — cutover `/v2`→`/` | ⏳ |
...
Остаётся в Ф5: e2e-сетка ключевых сценариев (Playwright как тест-раннер ещё
не настроен — нужно решение по объёму/инфраструктуре).
