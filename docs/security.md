...
- [ ] Защитные заголовки: HSTS, CSP, X-Content-Type-Options, Referrer-Policy. (Этап 4)
- [x] Секреты не уходят на фронт; в БД зашифрованы; ключ вне git. (Этап 3)
- [x] Нет секретов в git и его истории. (Этап 0)
- [ ] `/docs` закрыт; опасные ручки под замком; parse_url с allowlist. (Этап 4)
- [ ] Наружу не уходят стек-трейсы и версии. (Этап 4)
