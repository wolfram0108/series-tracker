...
// Перечитывание по запросу модалки (переход на вкладку «Композиция»): данные
// могли измениться фоновым усыновлением после «Сохранить» — иначе показывали
// бы состояние на момент открытия модалки до ре-монтажа.
