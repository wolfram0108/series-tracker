    ...
    <div>
        <div v-if="isLoading" class="animate-pulse">
            <div class="modern-fieldset mb-4">
                <div class="fieldset-header"><div class="skeleton-line short" style="height: 20px;"></div></div>
                <div class="fieldset-content">
                    <div class="skeleton-line long mb-3"></div>
                    <div class="row">
        ...
        <div v-else>
            ...
            <div class="modern-fieldset mb-4">
                ...
                <div class="fieldset-content">
                    <div class="modern-form-group">
                        <label class="modern-label">URL-адрес сериала (генерируется)</label>
                        <input :value="reconstructedUrl" type="text" class="modern-input" readonly>
                    </div>
                    <div class="row">
            ...
            <div v-if="editableSeries.source_type === 'torrent'">
                ...
                <div class="position-relative">
                    <div v-if="siteTorrentsLoading" class="div-table table-site-torrents animate-pulse">
                    ...
                    <div v-else class="div-table table-site-torrents">
  ...
  methods: {
    async load() {
        ...
        try {
            ...
            if (this.editableSeries.source_type === 'torrent') this.refreshSiteTorrents(); 
    ...
    async updateSeries() {
        this.isSaving = true;
        try {
            let qualityString = ''; const site = this.editableSeries.site;
            if (site.includes('anilibria') || site.includes('aniliberty')) { qualityString = this.editableSeries.quality; } 
            else if (site.includes('astar')) {
